        ...
        //    $sql ="SELECT * FROM user_account where id = '".$_SESSION['userLogin']."' ";		
           ...
           // $edu= mysqli_fetch_array ($result);
            ...
            ?>
                    ...
                    <a class="btn btn-outline-success" role="button" data-toggle="collapse" data-target="#target2" style="margin-top:30px;font-size: 14px;"><i class="bi bi-plus" style="font-size: 14px;"></i>ADD EDUCATION</a>
           ...
           // $experience = mysqli_fetch_array ($result);
            ?>
                    ...
                    <a class="btn btn-outline-success" role="button" data-toggle="collapse" data-target="#target2" style="margin-top:30px;font-size: 14px;"><i class="bi bi-plus" style="font-size: 14px;"></i>ADD WORK EXPERIENCE</a>
                        <div  class="collapse myTarget" id="target2">
               ...
               //         $achievement= mysqli_fetch_array ($result);
                    ...
                    <a class="btn btn-outline-success" role="button" data-toggle="collapse" data-target="#target2" style="margin-top:30px;font-size: 14px;"><i class="bi bi-plus" style="font-size: 14px;"></i>ADD ACHIEVEMENT</a>
                        <div  class="collapse myTarget" id="target2">
                    ...
                    <a class="btn btn-outline-success" role="button" data-toggle="collapse" data-target="#target2" style="margin-top:30px;font-size: 14px;"><i class="bi bi-plus" style="font-size: 14px;"></i>ADD SKILL</a>
                        <div  class="collapse myTarget" id="target2">
                 ...
                 //       $ref = mysqli_fetch_array ($result);
                    ...
                    <a class="btn btn-outline-success" role="button" data-toggle="collapse" data-target="#target2" style="margin-top:30px;font-size: 14px;"><i class="bi bi-plus" style="font-size: 14px;"></i>ADD REFERENCES</a>
                        <div  class="collapse myTarget" id="target2">
                        <form action="reference.php" method="post">
                        <h5 class="modal-title" style="color:#3cca7e; font-weight: 900; text-align: center;" id="exampleModalLabel">Add References</h5> 
